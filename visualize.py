...
def get_hist(image, label):
    ...
    return hist
def visualize_hist():
    INFER_DIR1 = './SECOND2/val/label1/'  # Inference path1
    INFER_DIR2 = './SECOND2/val/label2/'  # Inference path2
    LABEL_DIR1 = './test/out1/'  # GroundTruth path
    LABEL_DIR2 = './test/out2/'  # GroundTruth path
    infer_path_list1 = []
    infer_path_list2 = []
    label_path_list1 = []
    label_path_list2 = []
...
if __name__ == '__main__':
    ...
    # trans_prob_mat = trans_mat / np.sum(trans_mat, 1)
